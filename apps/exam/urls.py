...
urlpatterns = [
    ...
    path("question_center/import_questions/", views.import_questions, name="import_questions"),
    ...
    path("exam/player/start_exam/termsandconditions", views.start_exam_termsandconditions, name="start_exam_termsandconditions"),
]
